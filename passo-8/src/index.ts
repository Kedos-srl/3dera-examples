    ...
    HederaJS.start().then(() => {
        HederaJS.fetchAndLoadAssets({
            ...
            let stopAlarm = () => {
                ...
                clearInterval(idGavelAnimation);
                gavelRotation = 0;
                HederaJS.world.setRotation(gavel, 0, 0, gavelRotation);
            };
            ...
            const gavel = HederaJS.world.getEntity("gavel");
